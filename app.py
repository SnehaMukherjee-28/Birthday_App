...
if option == "1. আমাদের খিচুড়ি":
    ...
    memories = [
        ...
        {"file": "photo5.jpg", "caption": "সেই কুইন অফ হিলসের কোলে হাজারো রোমান্স আর মিষ্টি বকাঝকার সাতকাহন শেষে, এই অক্টোবরে কি তবে ভাইজাগ নয়, অন্য কোনো রহস্যময় ডেরায় জমবে  জীবনের সেরা ঝকঝকে মহরত?✨🏔️❤️"},
        {"file": "photo6.jpg", "caption": "Ghutnu রানী, বড়ই সেয়ানি! 👑"},
        {"file": "photo7.jpg", "caption": "আমরা দুজনে একসাথে থাকা মানেই মোহনবাগানের জয় নিশ্চিত, তাই লক্ষ্মীটি হয়ে থাকো—আমার সাথে একদম No ঝগড়া!💚❤️"},
        ...
        {"file": "photo9.jpg", "caption": " আমার সাথে চল একটু পথ যদি চাস... ভালো থাকিস খুব মাগি! ❤️✨"},
        {"file": "photo10.jpg", "caption": "অবশেষে বলি, আমি বাইরে চলে যাচ্ছি। খুব মজা হবে তোর। কেউ জ্বালাবে না তোকে, কেউ খ্যাপাবেও না। তাই এখনই বলে দিচ্ছি—নিজের যত্ন নিবি। মাসি-মেসোকে সাবধানে রাখবি। আমি সবসময় তোর জন্য আছি। অনেক ইমোশনাল বকবক করেছি। পরের সেকশনে যা এবার, আরও বোরিং জিনিস বাকি আছে! 😉❤️✨"}
...
# Option 3: Personalized Quiz
    ...
    if q1 == "এই বোরিং জিনিসটা কতক্ষণ চলবে?": # Answer change kore nio
        ...
        st.error("😡বাহ্!!! এটা ভুল করলি!!! গরু!! ছাগল!!! এইজন্যই বলি তুমি আমায় একটুও ভালোবাসো না। শুধুই বেস্ট ফ্রেন্ড... লাভ ইউ ওয়ালি তোমার চোখের মণি! 😤🙄")
    ...
    if q3 == "তোকে জ্বালানো": # Swap if you like beaches!
        ...
        st.error("সরি সোনা... তবে আমার কাছে তোকে জ্বালানোর চেয়ে বড় ইম্পর্ট্যান্ট কাজ আর কিচ্ছুটি নেই!😜🔥✨")
    ...
    if q4 == "639179":
        ...
        st.error("😡 উহুহুহুহুউউউউউ... সব কিছুতেই তুই থাকবি নাকি Baal!! যা, তোর ওই ওয়েভলেংথ ম্যাচকারিণীর কাছে... হুহ্‌!🙄💅✨")

    # Question 5
    q5 = st.radio("5. আমাদের দুজনের একসাথে দেখা প্রথম মোহনবাগানের ম্যাচ কোনটা?? এটা কিন্তু তোর পারা উচিত!", ["MBSG vs Kerala", "CMBSG vs FC Goa", "MBSG vs Bangalore"], index=None)
    if q5 == "MBSG vs Bangalore":
        st.success("😘 জানতাম তুই পারবি এটা.. জয় মোহনবাগান!💚🏹❤️")
        score += 1
    elif q5 is not None:
    ...
    if q6 == "তোর সাথেই থাকবো।":
        st.success("😘 তাহলে থেকে যা না হয় আমার সাথেই!ভালো করে পোড়া রান্না করে, সারাক্ষণ জ্বালিয়ে আর খুব যত্নে আগলে রেখে, মাসি,মেসোকে এক্কেবারে পাকড়াও করে নিজের কাছেই রেখে দেব!🍳📚🔒✨😉💅✨")
        score += 1
    elif q6 is not None:
        st.error("😡 যা খুশি কর, পানা পুকুরে মাছের কামড় kha!")
    ...
    if st.button("Submit My Final Score"):
        if score == 6:
            st.balloons()
            st.success(f"Perfect 6/6! A birthday Score!! Finally Happy 35th Birthday Anupam. Many many happy returns of this day  ❤️")
        else:
            st.warning(f"তোর স্কোর {score}/6. জন্মদিন বলে ছেড়ে দিলুম! Finally Happy 35th Birthday Anupam. Many many happy returns of this day  😂")
